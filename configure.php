...
?>
    ...
    <td align="left" colspan="2"><select name="confHardware">
		...
		<option<?php if ($configModem['Modem']['Hardware'] === 'dvmpic') { echo ' selected="selected"';}?> value="dvmpic">DV-Mega Cast Base Radio (main unit)</option>
		<option<?php if ($configModem['Modem']['Hardware'] === 'dvmpihs') { echo ' selected="selected"';}?> value="dvmpihs">DV-Mega Cast Hotspot - Single Band (70cm)</option>
		<option<?php if ($configModem['Modem']['Hardware'] === 'dvmpihd') { echo ' selected="selected"';}?> value="dvmpihd">DV-Mega Cast Hotspot - Dual Band (2m/70cm)</option>
		</select></td>
    </tr>
    <tr>
